<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="KisiDuzenle.aspx.cs" Inherits="_25112023_WebformsVeritabani.KisiDuzenle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        ...
        <tr>
            <td></td>
            <td>
                <asp:Button ID="btnGuncelle" runat="server" Text="Düzenle" Width="125px" OnClick="btnGuncelle_Click" /></td>
        </tr>
    </table>
